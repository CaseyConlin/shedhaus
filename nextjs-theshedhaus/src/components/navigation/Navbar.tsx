...
//         // className="absolute inset-0 w-10 h-10 transition-transform duration-300 scale-100 group-hover:scale-0 origin-center"
//         fill="currentColor"
//         //   viewBox="0 0 24 24"
...
//     {/* <Image
//       src="/shedhaus-shed.svg"
//       alt="Small Shed Icon"
//       width={20}
//       height={20}
//       className={`${hovered ? "scale-125 transition duration-300 ease-in-out" : "transition duration-300 ease-in-out"}`}
//     /> */}
...
//   return (
//     <nav className="flex items-center justify-between w-full font-montserrat font-black">
//       <div className="me-2 flex-1 flex justify-end">
...
//       <div className="ms-2 flex-1 flex justify-start">
